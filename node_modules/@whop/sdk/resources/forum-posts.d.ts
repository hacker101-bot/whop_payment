...
export declare namespace ForumPostUpdateParams {
    /**
     * Input for an attachment
     */
    interface Attachment {
...
export declare namespace ForumPosts {
    export { type ForumPostVisibilityType as ForumPostVisibilityType, type ForumPostListResponse as ForumPostListResponse, type ForumPostListResponsesCursorPage as ForumPostListResponsesCursorPage, type ForumPostCreateParams as ForumPostCreateParams, type ForumPostUpdateParams as ForumPostUpdateParams, type ForumPostListParams as ForumPostListParams, };
}
