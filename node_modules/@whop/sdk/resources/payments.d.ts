 ...
 */
export type CardBrands = 'mastercard' | 'visa' | 'amex' | 'discover' | 'unionpay' | 'jcb' | 'diners' | 'link' | 'troy' | 'visadankort' | 'visabancontact' | 'china_union_pay' | 'rupay' | 'jcbrupay' | 'elo' | 'maestro' | 'tarjeta_naranja' | 'cirrus' | 'nspk_mir' | 'verve' | 'ebt' | 'private_label' | 'local_brand' | 'uatp' | 'wexcard' | 'uzcard' | 'meeza' | 'hrg_store_card' | 'girocard' | 'fuel_card' | 'dankort' | 'carnet' | 'atm_card' | 'china_union_payuzcard' | 'unknown';
/**
...
export declare namespace PaymentCreateParams {
    ...
    namespace CreatePaymentInputWithPlan {
        /**
         * Pass this object to create a new plan for this payment
         */
        interface Plan {
    ...
    interface CreatePaymentInputWithPlanID {
        /**
         * The ID of the company to create the payment for.
         */
        company_id: string;
...
export declare namespace Payments {
    export { type BillingReasons as BillingReasons, type CardBrands as CardBrands, type PaymentMethodTypes as PaymentMethodTypes, type PaymentListResponse as PaymentListResponse, type PaymentListFeesResponse as PaymentListFeesResponse, type PaymentListResponsesCursorPage as PaymentListResponsesCursorPage, type PaymentListFeesResponsesCursorPage as PaymentListFeesResponsesCursorPage, type PaymentCreateParams as PaymentCreateParams, type PaymentListParams as PaymentListParams, type PaymentListFeesParams as PaymentListFeesParams, type PaymentRefundParams as PaymentRefundParams, };
}
